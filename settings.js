...
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=vcUHiIxb#DQQ_xEa4q_FGYnCUvru7AcggPIckaTg-abMEdVly3EU' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "2349033769727,2348107600168" : process.env.MODERATORS ,    
MAX_SIZE: process.env.MAX_SIZE === undefined ? '1536': process.env.MAX_SIZE,/*add this in megabytes*/    
OWNER_NAME: process.env.OWNER_NAME || 'Coach-Joseph' ,
